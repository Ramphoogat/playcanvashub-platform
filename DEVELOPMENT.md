...
```bash
git remote add encore encore://playcanvashub-platform-urdi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/playcanvashub-platform-urdi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/playcanvashub-platform-urdi/settings/integrations/github)
